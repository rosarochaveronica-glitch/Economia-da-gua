export const perguntas = [
    {
        enunciado: "Qual é a principal fonte de vida?",
        alternativas: [
            {
                texto: "Água doce.",
                afirmacao: [
    ...
    {
        enunciado: "A água é um recurso infinito?",
        alternativas: [
            {
                texto: "Não, é finito.",
                afirmacao: [
    ...
    {
        enunciado: " O que causa a pressão nos reservatórios?",
        alternativas: [
            {
                texto: "Crescimento populacional.",
                afirmacao: [
    ...
    {
        enunciado: "  Qual setor consome muita água com lavouras?",
        alternativas: [
            {
                texto: "Setor agrícola.",
                afirmacao: [
                    "Vem impulsionando a inovação na área de IA e luta para abrir novos caminhos profissionais com IA.",
                    "Participa ativamente do desenvolvimento de soluções criativas e na melhoria de processos em IA."
                ],
    ...
    {
        enunciado: "Como evitar desperdício ao escovar dentes?",
        alternativas: [
            {
                texto: "Fechar a torneira.",
                afirmacao: [
